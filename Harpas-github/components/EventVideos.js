...
const EventVideos = () => {
    return (
        <View style={styles.container}>
            ...
            <View style={{ alignItems: "center", marginTop: 5, flexDirection: "row", borderWidth: 1, borderRadius: 10, marginBottom: 15, }}>
            ...
            <View style={{ borderBottomWidth: 1, flexDirection: "row", }}>
                <Image source={require("../assets/images/logo-event.png")} style={{ width: 128, height: 140, marginBottom: 5, }} />
                <View style={{ flexDirection: "column", }}>
            ...
            <View>
                ...
                <Text style={{ fontSize: 20, fontWeight:"bold", marginTop: 2, marginBottom: 10, marginLeft: 55, color: "#4D0A8E" }}>Harpas For The Gigs</Text>
            </View>
